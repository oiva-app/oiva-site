---
title: "Manual Setup"
description: "A manual guide for deploying Oiva on AWS"
order: 1
sidebarLabel: "Manual Setup"
---
...
For more details on these credentials and other environment variables, see the [Configuration page](/get-started/configuration/).
...
- method: `POST`
- payload: use Oiva's [Honeycomb alert webhook payload template](https://github.com/oiva-app/oiva/blob/main/README.md#alert-webhook-payload-format)
